...
```{python}
#| tbl-cap: "Number of tweets per sentiment (positive vs negative)"
#| label: tbl-sentiment-counts
sent_count_df = tweets["Sentiment"].value_counts().to_frame(name="count")
Markdown(sent_count_df.to_markdown())
```
