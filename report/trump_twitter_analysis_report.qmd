...
author: 
  - "Group 14: Quan Hoang, Mailys Guedon, Joel Peterson, Li Pu"
jupyter: python3
format:
  html:
    toc: true
...
![Number of tweets per sentiment (positive, neutral, negative).](../results/figures/sentiment_counts.png){#fig-sentiment-dist height=400px}
